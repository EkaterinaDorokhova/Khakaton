...
1. [Дальнейшее развитие продукта](#дальнейшее-развитие-продукта)
   ...
   - [Ограничения модели](#ограничения-модели)
     - [1. Ошибки в определении стиля](#1-ошибки-в-определении-стиля)
     - [2. Ограниченный список стилей](#2-ограниченный-список-стилей)
     - [3. Работа со смешанными стилями](#3-работа-со-смешанными-стилями)
...
2. [Реализация проекта при развёртывании своей модели](#реализация-проекта-при-развёртывании-своей-модели)
   ...
   - [Масштабирование проекта](#масштабирование-проекта)
     - [1. Масштабирование датасета](#1-масштабирование-датасета)
     - [2. Масштабирование функциональности](#2-масштабирование-функциональности)
   - [Тонкая настройка модели](#тонкая-настройка-модели)

3. [План реализации проекта при самостоятельном развертывании сервисов](#план-реализации-проекта-при-самостоятельном-развертывании-сервисов)
   ...
   - [4. Развертывание сервиса, тестирование, оптимизация, поддержка](#4-развертывание-сервиса-тестирование-оптимизация-поддержка)
   ...
   - [5. Развитие проекта](#5-развитие-проекта)
     - [Новые возможности](#новые-возможности)
     - [Потребуемые ресурсы и технологии](#потребуемые-ресурсы-и-технологии)
